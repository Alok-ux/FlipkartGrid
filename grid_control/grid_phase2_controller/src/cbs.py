...
class State(object):
    ...
    def is_near_except_time(self, state):
        ...
        return self.location == state.location or Location(x+1, y) == state.location or Location(x-1, y) == state.location or Location(x, y+1) == state.location or Location(x, y-1) == state.location or Location(x+1, y+1) == state.location or Location(x+1, y-1) == state.location or Location(x-1, y+1) == state.location or Location(x-11, y-1) == state.location
    def __str__(self):
