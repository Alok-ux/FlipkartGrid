...
class listen():
    ...
    def bot_error(self,deg,x1,y1,*arg2):
        ...
        elif arg2[1] >= list4[1][1]-30 and deg <= 178 and flag1 == False :
            print("in 2")
    ...
    def rev_bot_error(self,deg,x1,y1,*arg2):
        arg2 = list(arg2)
        global list4,p,i,d,flag2,flag5,flag6,flag7,flag8
        ...
        elif arg2[0] > list4[1][0]-66 and flag2 == True and deg > 80:
            print("in 7")
