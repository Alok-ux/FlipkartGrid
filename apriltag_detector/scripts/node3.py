...
class listen():
    ...
    def bot_error(self,deg,x1,y1,*arg2):
        arg2 = list(arg2)
        global list2,p,i,d,flag1,flag3,flag4
        if arg2[1] < list2[1][1] and flag1 == False:
            print("in 1")
            err = list2[1][0]-arg2[0]
            mod1 = (x1**2+y1**2)**0.5
            err_deg = 90 - math.degrees(math.acos(x1/mod1))
            self.wheel_speed(err,err_deg)

        elif arg2[1] >= list2[1][1]-30 and deg <= 178 and flag1 == False :
            print("in 2")
        ...
        elif arg2[1] >= list2[1][1]-66 and deg >178 and flag1 == True and flag4 == False:
            flag3 = True
            flag4 = True
        elif arg2[1] >= list2[1][1]-66 and flag3 == True and flag1 == True:
            print("in 3")
            err = list2[1][1]-arg2[1]
            mod1 = (x1**2+y1**2)**0.5
    ...
    def rev_bot_error(self,deg,x1,y1,*arg2):
        arg2 = list(arg2)
        global list2,p,i,d,flag2,flag5,flag6
        if arg2[0] <= list2[2][0]+20 and flag2 == False:
            print("in 5")
            self.msg.linear.x = 0.0
            self.msg.linear.y = 0.0
            self.msg.linear.z = 0.0
        ...
        elif arg2[0] <= list2[1][0]-10 and flag2 == True and deg <= 2 and flag6 == False:
            flag5 = True
            flag6 = True
        elif arg2[0] <= list2[1][0]-10 and flag2 == True and flag5 == True:
            print("in 6")
            err = arg2[1]-list2[1][1]
            mod2 = (x1**2+y1**2)**0.5
            err_deg = math.degrees(math.acos(y1/mod2))-90
            self.wheel_speed(err,err_deg)

        elif arg2[0] > list2[1][0]-10 and flag2 == True and deg < 10 :
            self.msg.linear.x = 0.0
            self.msg.linear.y = 0.0
            self.msg.linear.z = 0.0
