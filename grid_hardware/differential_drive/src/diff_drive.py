...
class DifferentialDrive:
    def __init__(self, args):
        ...
        self.sub = rospy.Subscriber(args.vel, Twist, self.callback)
    ...
    def callback(self, data):
        ...
        msg = DiffRPM()
        msg.right_rpm = (2 * v + w * self.wheel_separation) * \
            60 / (2 * self.wheel_diameter*3.14)
        msg.left_rpm = (2 * v - w * self.wheel_separation) * \
            60 / (2 * self.wheel_diameter*3.14)
        rospy.loginfo(msg)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cmd_vel', type=str, default='cmd_vel',
                        help='cmd_vel topic, default:/grid_robot/cmd_vel')
    parser.add_argument('--rpm', type=str, default='rpm',
